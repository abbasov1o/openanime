...
enum ProviderType: String, Codable, CaseIterable, Hashable {
    ...
    case mal = "mal"
    case anizium = "anizium"   // anizium.co — the only tracker this build signs into
    ...
    /// `.local` is excluded because it has no account. AniList and MyAnimeList are
    /// currently disabled in this build — Anizium is the single sign-in target.
    static let userProviders: [ProviderType] = [.anizium]

    var displayName: String {
        switch self {
        case .anilist: return "AniList"
        case .mal: return "MyAnimeList"
        case .anizium: return "Anizium"
    ...
    var iconURL: String {
        ...
        case .anizium: return "https://anizium.co/assets/images/favicon.png"
