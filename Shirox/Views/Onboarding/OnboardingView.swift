...
struct OnboardingView: View {
    ...
    private var hasAccount: Bool { aniziumAuth.isLoggedIn }
        ...
        ScrollView {
            VStack(alignment: .leading, spacing: 0) {
                ...
                VStack(spacing: 10) {
                    ...
                    stepRow(
                        title: "Sign in to Anizium",
                        detail: accountDetail,
                        isDone: hasAccount,
                        isRequired: false,
                        action: { showAniziumLogin = true }
                    )
                }
                .padding(.top, 28)
    ...
    private var accountDetail: String {
        if let nick = aniziumAuth.user?.nick { return nick }
        if aniziumAuth.isLoggedIn { return "Signed in" }
        return "Watch with your anizium.co account"
    }
