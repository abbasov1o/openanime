...
private struct ProvidersSettingsSection: View {
    ...
    @ObservedObject private var malAuth = MALAuthManager.shared
    @ObservedObject private var aniListAuth = AniListAuthManager.shared
    @ObservedObject private var aniziumAuth = AniziumAuthManager.shared
        ...
        Button(isLoggedIn ? "Sign Out" : "Sign In") {
            if isLoggedIn {
                ...
                case .mal:
                    ...
                    #endif
                // Anizium has no OAuth sheet — its nick/e-mail + password form
    ...
    private func isSignedIn(_ type: ProviderType) -> Bool {
        ...
        case .anizium: return aniziumAuth.isLoggedIn
    ...
    private func providerStatus(_ provider: any MediaProvider) -> String {
        ...
        case .anizium:
            guard aniziumAuth.isLoggedIn else { return "Not signed in" }
            return aniziumAuth.needsReauthentication ? "Sign in again" : "Signed in"
